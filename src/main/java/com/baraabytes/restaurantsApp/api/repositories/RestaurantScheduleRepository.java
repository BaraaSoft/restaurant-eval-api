...
public interface RestaurantScheduleRepository extends JpaRepository<Schedule,Long> {
    ...
    List<Schedule> findAllByDayEqualsAndOpenTimeGreaterThanEqualAndCloseTimeLessThan(WeekDayType weekDayType,LocalDateTime openTime,LocalDateTime closeTime);
}
